export default {
    ...
    job: {
        ...
        history: {
            ...
            detailTrigger: "Trigger type",
            detailStart: "Start time",
            detailEnd: "End time",
            detailFire: "Fire time",
            detailInstance: "Instance",
            detailScheduler: "Scheduler",
            detailParams: "Params",
            detailError: "Stack trace",
            loadFailed: "Failed to load execution logs",
