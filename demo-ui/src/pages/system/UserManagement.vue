  ...
  <div class="system-module">
    <div class="module-head">
      ...
      <div class="module-actions">
        <el-input v-model.trim="filters.userName" placeholder="用户名" clearable />
        <el-input v-model.trim="filters.nickName" placeholder="昵称" clearable />
    ...
    <el-table :data="users" size="small" v-loading="loading" row-key="id">
      ...
      <el-table-column label="操作" width="220">
        <template #default="{row}">
          ...
          <el-button text size="small" @click="openRoles(row)">分配角色</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog v-model="roleVisible" title="分配角色" width="480px" align-center>
      ...
      <template #footer>
        ...
        <el-button type="primary" :loading="assigning" @click="saveRoles">保存</el-button>
      </template>
    </el-dialog>

    <el-dialog v-model="resetVisible" title="重置密码" width="420px" align-center>
      <el-form label-position="top">
        <el-form-item label="新密码">
          <el-input v-model.trim="resetForm.newPassword" type="password" show-password />
        </el-form-item>
        <el-form-item label="确认密码">
          <el-input v-model.trim="resetForm.confirmPassword" type="password" show-password />
        </el-form-item>
      </el-form>
      <template #footer>
