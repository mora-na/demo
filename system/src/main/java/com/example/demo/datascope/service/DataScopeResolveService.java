...
import com.example.demo.common.mybatis.DataScopeRuleDefinition;
...
public class DataScopeResolveService {
    ...
    private void fillRuleAndSql(DataScopeResolveResponse response,
                                DataScopeEvaluator.FinalScope finalScope,
                                String scopeKey) {
        DataScopeRuleDefinition rule = null;
        Map<String, DataScopeRuleDefinition> rules = dataScopeRuleProvider == null ? null : dataScopeRuleProvider.getRuleMap();
